...
describe('Pagination', () => {
  ...
  it('renders page buttons when totalPages > 1', () => {
    renderWithI18n(<Pagination currentPage={1} totalPages={3} onPageChange={vi.fn()} />);
  ...
  it('disables previous button on first page', () => {
    renderWithI18n(<Pagination currentPage={1} totalPages={5} onPageChange={vi.fn()} />);
    expect(screen.getByLabelText('Previous page')).toBeDisabled();
  });

  it('disables next button on last page', () => {
    renderWithI18n(<Pagination currentPage={5} totalPages={5} onPageChange={vi.fn()} />);
