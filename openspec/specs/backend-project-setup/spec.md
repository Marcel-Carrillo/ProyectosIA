...
Defines the configuration, tooling, and environment requirements for the backend project. Ensures the project is installable, buildable, lintable, testable, and ready for local development with a containerised database.
