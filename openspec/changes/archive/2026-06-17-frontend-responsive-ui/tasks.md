...
- [x] 12.2 Load and apply `ai-specs/skills/commit/SKILL.md`: stage relevant files (exclude `.env`, `node_modules`, build artifacts), Conventional Commit message referencing `frontend-responsive-ui`. _(landed on master: a7455b2 + 26885c1)_
- [x] 12.3 Push `feature/frontend-responsive-ui`; `gh pr create`; report the PR URL in chat. _(work merged directly to master via the two commits above; no separate PR)_
