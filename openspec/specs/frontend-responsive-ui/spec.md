...
Defines the responsive behaviour of the storefront and admin catalog surfaces across mobile (360px baseline), tablet (768px), and desktop (≥992px) widths: no horizontal page scroll, 44×44px touch targets on mobile, table→card reflow on admin screens, and preserved desktop layouts.
