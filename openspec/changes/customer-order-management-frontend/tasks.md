...
- [x] 9.1 Load and apply `ai-specs/skills/commit/SKILL.md`

- [x] 9.2 Verify all tasks above are marked `[x]` and reports exist under `openspec/changes/customer-order-management-frontend/reports/` (7.4/7.6 pending E2E)

- [x] 9.3 Stage relevant files; exclude `.env`, `node_modules/`, `dist/`, `coverage/`

- [x] 9.4 Create commit: `feat(KAN-29): close customer order admin UI gaps`

- [x] 9.5 Push branch `feature/KAN-29-customer-order-management-frontend` to origin

- [x] 9.6 Run `gh pr create` and report PR URL in chat — PR #30

- [x] 9.7 Transition Jira KAN-29 to **En revisión** after PR open (or **Finalizado** after merge)
