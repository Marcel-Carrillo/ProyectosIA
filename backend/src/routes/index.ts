...
// Example:
//   import productAdminRoutes from './admin/productRoutes';
//   router.use('/api/admin/products', productAdminRoutes);
// ─────────────────────────────────────────────────────────────────────────────
...
// Example:
//   import productPublicRoutes from './public/productRoutes';
//   router.use('/api/public/products', productPublicRoutes);
// ─────────────────────────────────────────────────────────────────────────────
