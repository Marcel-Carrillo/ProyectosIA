...
Defines the shared infrastructure utilities — database client and structured logger — that underpin all application and domain logic. Establishes singleton patterns and data-safety rules that all future modules must follow.
